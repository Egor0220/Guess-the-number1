...
<div class="container mt-auto">
    ...
    <h1>Твое число было меньше загаданного</h1>
    <h1>У вас осталось <?=$matt?> попыт<?=$end_matt?></h1><br>
        ...
        <input placeholder="Еще раз введите в поле число от <?=$_SESSION['min_ran']?> до <?=$_SESSION['max_ran']?>, которое по вашему мнению загадал компьютер " type="number" min="<?=$min_ran?>" max="<?=$max_ran?>" name="your guess" class="form-control" >
